...
export const OBJECT_METADATA: Record<string, ObjectMetadata> = {
    ...
    tank: { baseSize: 28, displayName: "Tank", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    tank_1: { baseSize: 28, displayName: "Tank 1", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    tank_2: { baseSize: 28, displayName: "Tank 2", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    healer: { baseSize: 28, displayName: "Healer", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    ...
    pure_healer: { baseSize: 28, displayName: "Pure Healer", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    barrier_healer: { baseSize: 28, displayName: "Barrier Healer", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    dps: { baseSize: 28, displayName: "DPS", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    ...
    melee_dps: { baseSize: 28, displayName: "Melee DPS", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    ...
    ranged_dps: { baseSize: 28, displayName: "Ranged DPS", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    ...
    physical_ranged_dps: { baseSize: 28, displayName: "Physical Ranged DPS", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    magical_ranged_dps: { baseSize: 28, displayName: "Magical Ranged DPS", parameters: { size: SIZE_PARAM_50, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
    ...
    proximity: { baseSize: 248, displayName: "Proximity", parameters: { size: SIZE_PARAM, angle: ANGLE_PARAM, transparency: TRANSPARENCY_PARAM } },
