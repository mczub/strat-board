...
const FFXIV_ASSET_MAP: Record<string, AssetMapping> = {
    ...
    'rmage.png': { name: 'magical_ranged_dps' },
    'role_dps.png': { name: 'dps' },

    // Jobs
    'pld.png': { name: 'paladin' },
    'war.png': { name: 'warrior' },
    'drk.png': { name: 'dark_knight' },
    'gnb.png': { name: 'gunbreaker' },
    'whm.png': { name: 'white_mage' },
    'sch.png': { name: 'scholar' },
    'ast.png': { name: 'astrologian' },
    'sge.png': { name: 'sage' },
    'mnk.png': { name: 'monk' },
    'drg.png': { name: 'dragoon' },
    'nin.png': { name: 'ninja' },
    'sam.png': { name: 'samurai' },
    'rpr.png': { name: 'reaper' },
    'vpr.png': { name: 'viper' },
    'bard.png': { name: 'bard' },
    'mch.png': { name: 'machinist' },
    'dnc.png': { name: 'dancer' },
    'blm.png': { name: 'black_mage' },
    'smn.png': { name: 'summoner' },
    'rdm.png': { name: 'red_mage' },
    'pct.png': { name: 'pictomancer' },
    'blu.png': { name: 'blue_mage' },
